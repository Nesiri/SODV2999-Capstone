export default function HomepageNewsCompanionPaws() {
    return(
        <div>
            <h1>Companion Paws Canada</h1>

            <h2>Companion Paws is dedicated to supporting Canadians in need while also providing a second chance for pets in rescues.</h2>
