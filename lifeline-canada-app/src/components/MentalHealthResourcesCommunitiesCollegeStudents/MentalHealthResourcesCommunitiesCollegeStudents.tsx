...
import studentCopingGuide from "../../assets/StudentGuidetoCopingwithEmotionalCrisis.pdf";
                    ...
                    <div className="mt-6 space-y-4">
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <ul className="space-y-2 list-disc list-inside leading-relaxed">
                                ...
                                <li>Let the student know you are glad they are back, "Good to see you".</li>
                                <li>Please respect the student's wishes for the way in which his absence is discussed. If the attempt is common knowledge, help the student prepare by role-playing comments and questions from peers or faculty or staff. If no one is really aware, help the student create a short response to explain her absence. Being prepared helps greatly reduce anxiety and helps the student feel more in control.</li>
                                <li>Discuss missed classwork and homework and make arrangements for completion. Adjust expectations for the first days and weeks. Let her know that she can come to you for help with the work or assign a student to help her catch up. Some teachers will give a project or a take home assignment for the student to do instead of trying to make up all of the missed homework.</li>
                                <li>Keep an eye on the student's academic performance as well as her social interactions. If you see that she is isolating or being shunned by peers or is falling further behind in assignments you can follow up with the students and other teachers as well.</li>
                                <li>Pay close attention to further absences, lateness and requests to be excused during classes. If you are concerned please alert the appropriate staff resource at your school.</li>
                                <li>Encourage the student to use the school resources for additional support (school counselor).</li>
                                <li>Always provide regular feedback to school resource staff.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-8 rounded-2xl border border-purple-100 bg-white/90 backdrop-blur-sm shadow-sm p-6 sm:p-8 text-gray-700">
                    ...
                    <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <p className="mt-3 text-sm leading-relaxed">
                                Helping colleges and universities enhance capacity to support student mental health and well-being.
                            </p>
                        </div>
