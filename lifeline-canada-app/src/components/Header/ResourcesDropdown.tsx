    ...
    >
      ...
      <button
        ...
        className={`
          ...
          text-gray-800 dark:!text-gray-800 hover:!text-[#5f2d85] dark:hover:!text-[#5f2d85]
        `}
      ...
      ${
        activeCategory === group.category
          ? '!bg-gray-100 dark:!bg-gray-100 border border-gray-200 dark:!border-gray-200 shadow-sm !text-[#5f2d85] dark:!text-[#5f2d85]'
          : 'text-gray-600 dark:!text-gray-600 hover:!text-[#5f2d85] dark:hover:!text-[#5f2d85] hover:bg-gray-50/70 dark:hover:!bg-gray-50/70 border border-transparent hover:border-gray-200 dark:hover:!border-gray-200'
      }
    `}
                  >
          ...
          ${
            activeCategory === group.category
              ? '!bg-gray-200 dark:!bg-gray-200 !text-[#5f2d85] dark:!text-[#5f2d85]'
              ...
              {activeCategory && (
                <div className="p-4 h-full">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-sm font-normal !text-[#5f2d85] dark:!text-[#5f2d85] truncate">
                      {activeCategory}
                    </h4>
                  </div>
                      ...
                      ?.links.map((link) => (
                        ...
                        >
                          <div className="flex items-center min-w-0">
                            {link.icon && (
                              <span
                                className="mr-2 text-gray-500 dark:!text-gray-500 group-hover:!text-[#5f2d85] dark:group-hover:!text-[#5f2d85] 
                            ...
                            <div className="flex-1 min-w-0">
                              <span
                                className="text-xs text-gray-700 dark:!text-gray-700 group-hover:!text-[#5f2d85] dark:group-hover:!text-[#5f2d85] 
