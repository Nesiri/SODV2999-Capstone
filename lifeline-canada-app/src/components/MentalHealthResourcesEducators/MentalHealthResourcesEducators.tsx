...
import supportingMinds from "../../assets/supportingMinds.pdf";
        ...
        <div className="mt-8 rounded-2xl border border-purple-100 bg-white/90 backdrop-blur-sm shadow-sm p-6 sm:p-8 text-gray-700">
          ...
          <div className="mt-6 grid gap-4 sm:gap-5">
            <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
              <a
                href={supportingMinds}
                className="text-lg font-semibold text-purple-700 hover:text-purple-800 underline underline-offset-4"
              >
                Supporting Minds: An Educator&apos;s Guide to Promoting Students&apos; Mental Health &amp; Well-Being
              </a>
            ...
            <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
              <a
                ...
                className="text-lg font-semibold text-purple-700 hover:text-purple-800 underline underline-offset-4"
              >
                How to Make a Difference When You Witness Bullying Online (Grades: 7 to 9)
              </a>
              <p className="mt-2 leading-relaxed">
