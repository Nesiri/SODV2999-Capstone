...
import companionpawslogo from '../../assets/CPCLogo72dpi.png';
    ...
    },
    {
      ...
      icon: (
        ...
        >
          ...
          <circle cx="12" cy="10" r="1.5" fill="#f5f1f7" />
        </svg>
      ),
      color: 'from-[#5f2d85] to-[#7b3fa0]',
      bgColor: '!bg-white',
    ...
    },
    {
      ...
      icon: (
        ...
        >
          ...
          <circle cx="12" cy="12" r="1" fill="#f5f1f7" />
        </svg>
      ),
      color: 'from-[#5f2d85] to-[#7b3fa0]',
      bgColor: '!bg-white',
      ...
      <section className="relative w-[95vw] sm:w-full py-12 sm:py-16 md:py-20 lg:py-28 overflow-hidden bg-gradient-to-br from-purple-50 via-white to-purple-100">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="hidden sm:block absolute top-20 left-10 opacity-5 cp-float-slow">
            <svg
              className="w-16 sm:w-20 md:w-24 h-auto !text-[#5f2d85]"
              fill="#f5f1f7"
              viewBox="0 0 24 24"
            >
          ...
          <div className="hidden sm:block absolute bottom-20 right-10 opacity-5 cp-float-slow cp-delay-2000">
            <svg
              className="w-24 sm:w-28 md:w-32 h-auto !text-[#5f2d85]"
              fill="#f5f1f7"
              viewBox="0 0 24 24"
            >
              <path d="M5.5 7.5C6.33 7.5 7 8.17 7 9c0 .83-.67 1.5-1.5 1.5S4 9.83 4 9c0-.83.67-1.5 1.5-1.5zm13 0c.83 0 1.5.67 1.5 1.5 0 .83-.67 1.5-1.5 1.5S17 9.83 17 9c0-.83.67-1.5 1.5-1.5zm-6.5 9c1.5 0 3 1.5 3 3s-1.5 3-3 3-3-1.5-3-3 1.5-3 3-3zm-6-6c.83 0 1.5.67 1.5 1.5S7.33 13 6.5 13 5 12.33 5 11.5 5.67 10 6.5 10zm11 0c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5.67-1.5 1.5-1.5z" />
          ...
          <div className="absolute -bottom-20 sm:-bottom-40 -left-20 sm:-left-40 w-48 sm:w-64 md:w-80 h-48 sm:h-64 md:h-80 bg-[#5f2d85] rounded-full mix-blend-multiply filter blur-2xl sm:blur-3xl opacity-10 sm:opacity-20 cp-blob cp-delay-2000"></div>
        ...
        <div className="absolute right-0 top-1/2 transform -translate-y-1/2 opacity-5 hidden lg:block">
          <svg
            className="w-72 xl:w-96 h-auto !text-[#5f2d85]"
            viewBox="0 0 100 100"
            fill="#f5f1f7"
          >
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="inline-flex items-center justify-center mb-4 sm:mb-6">
              <img
                src={companionpawslogo}
                alt="Companion Paws Canada"
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center mb-16 lg:mb-20">
            ...
            >
              <div className="inline-block">
                <span className="px-3 sm:px-4 py-1.5 sm:py-2 bg-purple-100 !text-[#5f2d85] rounded-full text-xs sm:text-sm font-normal">
                  🐾 Our Programs
                </span>
              </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                {programs.slice(0, 3).map((program) => (
                  <a
                    ...
                    key={program.id}
                    className={`group relative overflow-hidden rounded-xl sm:rounded-2xl transition-all duration-500 transform hover:-translate-y-1 hover:shadow-xl sm:hover:shadow-2xl cursor-pointer block !bg-white`}
                  ...
                  >
                    ...
                    <div className="relative p-4 sm:p-6">
                      <div className="flex items-start gap-3 sm:gap-4">
                        {/* Icon container - white background with purple icon only */}
                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl !bg-white flex items-center justify-center shadow-md sm:shadow-lg transform group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                          <div className="!text-[#5f2d85]">{program.icon}</div>
                        </div>
                        ...
                        <div
                          className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gray-100 shadow-md flex items-center justify-center transform transition-all duration-300 flex-shrink-0 ${activeProgram === program.id ? 'translate-x-1 bg-[#5f2d85]' : ''}`}
                        >
                          <svg
              ...
              <div className="text-center sm:text-left mt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="!text-[#5f2d85] font-normal text-sm sm:text-base inline-flex items-center gap-1 group"
                >
              ...
              <div className="flex items-center gap-2 sm:gap-3 mt-6 sm:mt-8 p-3 sm:p-4 bg-gradient-to-r from-purple-100/50 to-purple-200/50 rounded-xl sm:rounded-2xl backdrop-blur-sm">
                <div className="relative flex-shrink-0">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#5f2d85] rounded-full flex items-center justify-center">
                    <svg
            ...
            >
              ...
              <div className="relative group max-w-md mx-auto lg:max-w-full">
                ...
                <div className="absolute -bottom-4 sm:-bottom-6 -right-4 sm:-right-6 w-20 sm:w-24 md:w-32 h-20 sm:h-24 md:h-32 bg-[#5f2d85] rounded-full opacity-30 sm:opacity-50 blur-xl sm:blur-2xl cp-pulse cp-delay-2000"></div>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-[#5f2d85] to-[#5f2d85] rounded-2xl sm:rounded-3xl blur-2xl sm:blur-3xl opacity-20"></div>
            ...
            <div className="relative !bg-white/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-2xl sm:shadow-3xl border border-white/50">
              <div className="max-w-3xl mx-auto">
                <h3 className="!text-xl sm:text-2xl md:text-3xl font-bold !text-[#5f2d85] mb-3 sm:mb-4">
                ...
                <div className="relative inline-block group w-full sm:w-auto">
                  <div className="absolute -inset-1 bg-gradient-to-r from-[#5f2d85] to-[#5f2d85] rounded-full blur opacity-70 group-hover:opacity-100 transition duration-300"></div>
                  <a
                    href="https://companionpaws.ca"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="relative inline-flex items-center justify-center gap-2 sm:gap-3 px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 bg-gradient-to-r from-[#5f2d85] to-[#5f2d85] text-white font-bold rounded-full shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto text-sm sm:text-base"
                  >
