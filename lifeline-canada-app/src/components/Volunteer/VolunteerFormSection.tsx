    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-8 animate-fadeInUp">
          ...
          <div className="backdrop-blur-sm !bg-white/90 rounded-3xl shadow-2xl shadow-[#5f2d85]/10 p-8 border border-white/40 transform hover:scale-[1.02] transition-all duration-500">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                type="checkbox"
                name="volunteerConfirmation"
                required
                className="mt-1 w-5 h-5 rounded border-gray-300 !text-[#5f2d85] focus:ring-[#5f2d85]"
              />
              <span className="text-gray-700">
                <span className="font-normal text-transparent bg-clip-text bg-gradient-to-r from-[#5f2d85] to-[#5f2d85]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#5f2d85] focus:ring-2 focus:ring-[#5f2d85]/30 transition-all !bg-white/70"
                  placeholder="John"
                />
              </div>
                  ...
                  {PRONOUNS.map((pronoun) => (
                    ...
                    >
                      <input
                        ...
                        onChange={handleInputChange}
                        required
                        className="w-4 h-4 !text-[#5f2d85] focus:ring-[#5f2d85]"
                      />
          ...
          <div className="backdrop-blur-sm !bg-white/90 rounded-3xl shadow-2xl shadow-[#5f2d85]/10 p-8 border border-white/40 transform hover:scale-[1.02] transition-all duration-500">
                ...
                {VOLUNTEER_SKILLS.map((skill) => (
                  ...
                  >
                    <input
                      ...
                      className="mt-1 w-4 h-4 rounded border-gray-300 !text-[#5f2d85] focus:ring-[#5f2d85] flex-shrink-0"
                    />
            ...
            <div className="space-y-4 pt-6">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-[#5f2d85] transition-colors !bg-white/40">
                  <input
                    type="file"
                  ...
                  <label htmlFor="resume-upload" className="cursor-pointer">
                    ...
                    <p className="!text-[#5f2d85] font-normal">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {TIME_COMMITMENTS.map((commitment) => (
                    <label
                      key={commitment}
                      className="flex items-center gap-2 p-3 border border-gray-200 rounded-xl hover:border-[#5f2d85] transition-colors !bg-white/40 cursor-pointer"
                    >
                      <input
                        type="radio"
                        name="timeCommitment"
          ...
          <div className="flex justify-center pt-4">
            <button
              type="submit"
              className="group relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#5f2d85] to-[#5f2d85] text-white px-12 py-5 rounded-2xl !text-xl font-bold shadow-xl shadow-[#5f2d85]/30 hover:shadow-2xl hover:shadow-[#5f2d85]/40 transition-all duration-300 hover:scale-105"
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#5f2d85] to-[#C77DDF] rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </button>
          </div>
        </form>
      </div>
