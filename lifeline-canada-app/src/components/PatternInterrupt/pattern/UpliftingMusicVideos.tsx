...
const videos: MusicVideo[] = [
  ...
  },
  {
    title: 'Stand By Me',
    artist: 'Ben E. King',
    description: 'We have to overcome our fears and comfort zones to progress.',
    youtubeUrl: 'https://www.youtube.com/watch?v=hwZNL7QVJjE',
  },
  {
    title: 'Take On Me',
    artist: 'Ah Ha',
    description: "Amazing rendition of the classic 80's hit.",
    youtubeUrl: 'https://www.youtube.com/watch?v=djV11Xbc914',
  },
  {
    title: "Don't Worry Be Happy",
    artist: 'Bobby McFerrin',
    description: 'Everyone is worried about something, take time to be happy.',
    youtubeUrl: 'https://www.youtube.com/watch?v=d-diB65scQU',
  },
  {
    title: 'Lovely Day',
    artist: 'Bill Withers',
    description: "There is always a way, you just haven't thought of it yet.",
    youtubeUrl: 'https://www.youtube.com/watch?v=bEeaS6fuUoA',
  },
  {
    title: 'Beautiful Day',
    artist: 'U2',
    description: 'Celebrate your victories, no matter how small.',
    youtubeUrl: 'https://www.youtube.com/watch?v=co6WMzDOh1o',
  },
  {
    title: 'Imagine',
    artist: 'John Lennon',
    description: 'Figure out what your dream is and strive for it.',
    youtubeUrl: 'https://www.youtube.com/watch?v=YkgkThdzX-8',
  },
  {
    title: 'We Are The Champions',
    artist: 'Queen',
    description: "Think about how far you've come and what you've learned.",
  ...
  },
  {
    ...
    description: 'A great feel-good song.',
    youtubeUrl: 'https://www.youtube.com/watch?v=iPUmE-tne5U',
  },
  {
    title: "Don't Stop Believing",
    artist: 'Journey',
    description: 'Remember what motivated you to start.',
    youtubeUrl: 'https://www.youtube.com/watch?v=1k8craCGpgs',
  },
  {
    title: 'Stronger',
    artist: 'Kelly Clarkson',
    description: 'Learn from setbacks and come back stronger.',
      ...
      <div className="w-full px-6 sm:px-8 lg:px-12 relative z-10">
        <div className="w-full lg:w-4/5 mx-auto">
          ...
          <h1 className="mt-2 !text-3xl sm:!text-4xl lg:!text-5xl font-black tracking-tight">
            <span className="!text-[#5f2d85]">Uplifting Music Videos</span>
          </h1>
          ...
          <main className="mt-6 !bg-white/70 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/50 text-gray-700 flex flex-col sm:flex-row gap-6 items-start">
            <div className="flex-1">
              <p className="leading-relaxed">
                There is something about a great uplifting song that can
                transport your emotions and feelings and mood to a much higher,
                happier level. Music is amazing that way and thank goodness we
                have great songwriters out there that can capture feelings of
                joy, empowerment and happiness and put those feelings to music.
              </p>
              <p className="mt-4 leading-relaxed">
                Take a moment when you need to be inspired and uplifted to have
                a listen to these fantastic uplifting music videos. Click the
                little box in the bottom right corner of the video for
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-3 flex-1">
                      <p className="font-normal !text-[#5f2d85] text-sm leading-snug">
                        {video.title}
                      </p>
