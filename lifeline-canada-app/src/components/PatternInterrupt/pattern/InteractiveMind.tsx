        ...
        <div className="flex flex-col items-center text-center">
          ...
          {row.button && row.href && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-3 inline-flex items-center justify-center rounded-md bg-[#5f2d85] px-4 py-2 text-xs font-normal uppercase tracking-wide text-white transition-colors duration-200 hover:bg-[#5f2d85]"
            >
              {row.button}
            </a>
          )}
        ...
        <div className="space-y-4">
          ...
          {!row.button && row.href && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className=" !text-[#5f2d85] inline-flex text-sm font-medium !text-[#5f2d85] hover:underline"
            >
              Visit resource
            </a>
          )}
      ...
      <div className="relative z-10 w-full px-6 sm:px-8 lg:px-12">
        <div className="mx-auto w-full lg:w-4/5">
          ...
          <h1 className="mt-2 text-3xl font-black tracking-tight sm:!text-4xl lg:text-5xl">
            <span className="!text-[#5f2d85]">Interactive Mind</span>
          </h1>
