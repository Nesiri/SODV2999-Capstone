  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <h3 className="!text-xl font-normal !text-[#5f2d85] hover:!text-[#5f2d85] underline underline-offset-4">
          {resource.title}
        </h3>
          ...
          <main className="mt-6 !bg-white/70 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/50 text-gray-700 flex flex-col sm:flex-row gap-6 items-start">
            <div className="flex-1">
              ...
              <p className="mt-4 leading-relaxed">
                ...
                energy. Even small acts of self-care in your daily life can have
                a big impact.
              </p>
              <p className="mt-4 leading-relaxed">
