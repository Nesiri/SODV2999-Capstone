          ...
          <div className="mx-auto grid max-w-4xl items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-5 text-[17px] leading-8 text-slate-800">
                ...
                not always possible for everyone. Mobile apps can offer another
                way to interact with supportive tools, build healthy routines,
                and access activities that improve emotional wellbeing.
              </p>

              <p className="mt-5 text-[17px] leading-8 text-slate-800">
                Studies and lived experience both suggest that mindfulness apps,
                mood tracking tools, guided breathing, journaling, and
                structured coping exercises can help reduce stress, anxiety, and
                feelings of depression when used consistently.
              </p>

              <p className="mt-5 text-[17px] leading-8 text-slate-800">
                The apps collected below are intended to be supportive
                resources. They are not meant to replace professional medical or
                clinical mental health care. Talking to a qualified professional
                is still one of the most important steps on the road to healing
