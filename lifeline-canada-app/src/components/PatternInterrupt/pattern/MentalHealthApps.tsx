...
const appRows: AppRow[] = [
  {
    ...
    alt: 'Calm Harm app',
    text: 'Calm Harm is designed to help users manage urges related to self-harm through private, guided tasks based on comfort, distraction, release, and breathing. It is simple, focused, and useful for moments when someone needs help getting through emotional intensity safely.',
  ...
  },
  {
    ...
    alt: 'notOK app',
    text: 'notOK makes it easier to reach trusted people quickly during overwhelming moments. Users can pre-select support contacts and send a distress alert with one tap. It is especially helpful for people who struggle to explain what they need in a crisis.',
  ...
  },
  {
    ...
    alt: 'Daylio app',
    text: 'Daylio helps users track mood, habits, routines, and daily patterns without needing to write long journal entries. Over time, it becomes easier to notice what improves mood, what triggers stress, and how daily habits affect emotional wellbeing.',
  ...
  },
  {
    ...
    alt: 'Moodfit app',
    text: 'Moodfit combines mood tracking with gratitude prompts, breathing tools, sleep tracking, and self-care check-ins. It gives structure to mental health support and can be useful for people who want both reflection and practical daily tools in one place.',
  ...
  },
  {
    ...
    text: 'MindShift CBT is built around evidence-based strategies for anxiety, panic, worry, perfectionism, and social anxiety. It includes short exercises, belief challenges, coping cards, and guided check-ins that help users build more balanced thought patterns.',
  ...
  },
  {
    ...
    alt: 'Sanvello app',
    text: 'Sanvello offers mood tracking, journaling, guided journeys, and coping tools for people dealing with stress, anxiety, and depression. It is designed to combine self-help structure with emotional check-ins and supportive routines.',
  ...
  },
  {
    ...
    text: 'Insight Timer includes a large library of guided meditations, breathing exercises, sleep tracks, and calming audio. It is useful for people who want mindfulness support, sleep help, or short calming sessions throughout the day.',
  ...
  },
  {
    ...
    text: 'Smiling Mind offers guided mindfulness programs designed for stress management, focus, sleep, and emotional wellbeing. It is beginner-friendly and works well for people who want a simple and steady introduction to mindfulness practice.',
...
function CategoryCardItem({ card }: { card: CategoryCard }) {
  return (
    <a href={`#${card.target}`} className="group block text-center">
      ...
      <p className="mt-4 text-[17px] font-normal !text-[#5f2d85]">
        {card.title}
      </p>
    </a>
  );
    ...
    <div className="group rounded-2xl border border-purple-100 !bg-white/90 p-5 sm:p-6 shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
      <div className="grid gap-5 md:grid-cols-[160px_1fr] md:items-start">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-3 text-[17px] font-normal !text-[#5f2d85]">
            {row.title}
          </p>
        ...
        <div className="space-y-4">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex rounded-md bg-[#5f2d85] px-4 py-2 text-xs font-normal uppercase tracking-wide text-white transition-colors duration-200 hover:bg-[#5f2d85]"
          >
            Visit App
          </a>
        </div>
      ...
      <div className="relative z-10 w-full px-6 sm:px-8 lg:px-12">
        <div className="mx-auto w-full lg:w-4/5">
          <div className="mb-4 text-sm text-gray-500">
            <Link
              to="/pattern"
              className="!text-[#5f2d85] hover:!text-[#5f2d85] hover:underline"
            >
              Pattern Interrupts
            </Link>{' '}
          ...
          <h1 className="mt-2 text-3xl font-black tracking-tight sm:!text-4xl lg:text-5xl">
            <span className="!text-[#5f2d85]">Mental Health Apps</span>
          </h1>
            ...
            <div className="grid items-center gap-8 md:grid-cols-[1.2fr_0.8fr]">
              <div>
                <p className="leading-relaxed">
                  Seeing a therapist or mental health professional regularly is
                  not always possible for everyone. Mobile apps can offer
                  another way to interact with supportive tools, build healthy
                  routines, and access activities that improve emotional
                  wellbeing.
                </p>
                <p className="mt-4 leading-relaxed">
                  Studies and lived experience both suggest that mindfulness
                  apps, mood tracking tools, guided breathing, journaling, and
                  structured coping exercises can help reduce stress, anxiety,
                  and feelings of depression when used consistently.
                </p>
                <p className="mt-4 leading-relaxed">
                  The apps collected below are intended to be supportive
                  resources. They are not meant to replace professional medical
                  or clinical mental health care. Talking to a qualified
                  professional is still one of the most important steps on the
                  road to healing and mental wellbeing.
                </p>
              </div>
          ...
          <section className="mt-8 rounded-2xl border border-purple-100 bg-gradient-to-br from-white via-purple-50/70 to-white p-6 shadow-sm backdrop-blur-sm sm:p-8 text-center">
            ...
            <div className="mx-auto mt-6 max-w-3xl space-y-5 text-[17px] italic leading-8 text-slate-700">
              <p>
                When choosing an online therapy provider or mental health app,
                it is important to read the company’s privacy information before
                you sign up. This can help you understand whether the app is
              ...
              <p>
                ...
                app, take a moment to understand how your information is
                handled.
              </p>
            </div>
          </section>
          ...
          <section
            ...
            className="mt-8 rounded-2xl border border-purple-100 !bg-white/90 p-6 shadow-sm backdrop-blur-sm sm:p-8"
          >
            <h2 className="text-2xl font-bold tracking-tight !text-[#5f2d85] sm:text-3xl">
              Suicide Prevention
            </h2>
          ...
          <section
            id="grounding-breathing"
            className="mt-8 rounded-2xl border border-purple-100 !bg-white/90 p-6 shadow-sm backdrop-blur-sm sm:p-8 pb-20"
          >
            <h2 className="text-2xl font-bold tracking-tight !text-[#5f2d85] sm:text-3xl">
              Grounding &amp; Breathing
            </h2>
