    ...
    resources: {
      ...
      items: [
        ...
        },
        {
          ...
          image:
            '/images/resources/self-management/coping-with-suicidal-thoughts.jpg',
          meta: 'Workbook',
          tags: ['Safety', 'Support'],
          kind: 'link',
        },
        ...
        },
        {
          ...
          image:
            '/images/resources/self-management/reasons-to-go-on-living.jpg',
          meta: 'Stories',
          tags: ['Hope', 'Recovery'],
          kind: 'link',
        },
        {
          ...
          image:
            '/images/resources/self-management/reasons-for-staying-alive.jpg',
          meta: 'Support',
    ...
    resources: {
      ...
      items: [
        ...
        },
        {
          title: 'Forest path',
          description:
            'Use this image to imagine walking somewhere quiet and safe.',
          image:
        ...
        },
        {
          title: 'Ocean horizon',
          description:
            'A wide, gentle view that can help slow racing thoughts.',
          image:
        ...
        },
        {
          ...
          description:
            'A simple image to create a sense of comfort and stillness.',
          image:
      ...
      items: [
        {
          ...
          description:
            'Walk slowly, notice 5 things you see, and breathe deeper than usual.',
        ...
        },
        {
          ...
          description:
            'Pick 3 songs: 1 comfort, 1 lift, 1 energy. Stop after song #3.',
          tags: ['Music', 'Energy'],
          icon: '🎧',
          meta: '5 min',
          image:
        ...
        },
        {
          ...
          description:
            'Write everything on your mind. Circle one thing you can act on today.',
        ...
        },
        {
          ...
          description:
            'Shoulder rolls, neck stretch, stand tall for 30 seconds.',
          tags: ['Body', 'Relief'],
          icon: '🧍',
          meta: '3 min',
          image:
        ...
        },
        {
          ...
          description:
            'Write 3 tiny things: warm drink, clean bed, a kind message.',
        ...
        },
        {
          ...
          description:
            'You don’t need a perfect message. Start with: “Can I share something?”',
    ...
    resources: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            'A short break that helps you breathe and reset your mind.',
      ...
      items: [
        {
          title: 'Be Phenomenal',
          description:
            'A high-energy reminder to show up fully — even on the days you feel tired or stuck.',
        ...
        },
        {
          ...
          description:
            'A gentle reminder that confidence is built through repetition, not perfection.',
        ...
        },
        {
          ...
          description:
            'A practical and inspiring talk about turning setbacks into meaningful work.',
        ...
        },
        {
          ...
          description:
            'A touching story about friendship, loyalty, and unexpected connection.',
        ...
        },
        {
          ...
          description:
            'A classic talk on joy, perspective, and living with intention.',
        ...
        },
        {
          title: 'Free Hugs',
          description:
            'Sometimes one small act of kindness can change someone’s whole day.',
        ...
        },
        {
          ...
          description:
            'A motivational reminder that persistence and purpose often go together.',
        ...
        },
        {
          title: 'Look Up',
          description:
            'A spoken-word reminder to reconnect with people, not just screens.',
        ...
        },
        {
          ...
          description:
            'A moving message about resilience, gratitude, and courage.',
        ...
        },
        {
          ...
          description:
            'A heartfelt story about perspective, love, and understanding sacrifice.',
    ...
    resources: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            'A reflective conversation that encourages pause, thought, and compassionate perspective.',
