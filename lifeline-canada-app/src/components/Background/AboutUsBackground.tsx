...
const AboutUsBackground: React.FC<AboutUsBackgroundProps> = ({ 
  ...
  return (
    <main className={`relative w-full min-h-screen bg-gradient-to-br from-purple-50 via-purple-100/50 to-indigo-50 font-sans antialiased ${className}`}>
      ...
      <div className="absolute bottom-0 left-0 w-[250px] md:w-[500px] h-[250px] md:h-[500px] bg-gradient-to-tr from-pink-200/30 via-purple-200/20 to-transparent rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }} />
