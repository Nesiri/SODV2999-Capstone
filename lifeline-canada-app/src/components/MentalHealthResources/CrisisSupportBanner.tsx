      ...
      <section className="relative w-full !bg-gradient-to-br from-purple-50 via-purple-100/50 to-purple-100 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto text-center px-4 sm:px-6 py-12 md:py-20 lg:py-24">
          ...
          <h2 className="!text-2xl sm:!text-3xl md:!text-4xl lg:!text-5xl font-bold text-black/80 mb-4 md:mb-6 leading-tight px-2">
            In Crisis? Canada's suicide prevention hotline
          </h2>

          {/* 988 section - mobile optimized */}
          <div className="relative mb-6 md:mb-8 flex flex-col items-center justify-center">
            <span className="!text-purple-900/90 text-base md:!text-xl lg:text-2xl mb-3 md:mb-4">
              Call or Text
            </span>
            <div className="absolute inset-0 !bg-gradient-to-r from-[#5f2d85]/30 to-pink-600/30 blur-3xl"></div>
            <div className="relative flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4">
              <p className="group relative inline-flex items-center justify-center gap-2 px-6 md:px-8 py-3 md:py-4 !bg-[#5f2d85] hover:!bg-[#5f2d85] rounded-xl md:rounded-2xl shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 transition-all duration-300">
          ...
          <p className="!text-[#5f2d85]/70 text-xs md:text-sm lg:text-base">
