...
const CrisisSupportBanner: React.FC = () => {
  return (
    <>
      <section className="relative w-full bg-gradient-to-br from-purple-50 via-purple-100/50 to-indigo-50 overflow-hidden">
        {/* Main content */}
        <div className="relative max-w-6xl mx-auto text-center px-4 sm:px-6 py-12 md:py-20 lg:py-24">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-black/80 mb-4 md:mb-6 leading-tight px-2">
            ...
            <span className="relative inline-block">
              <span className="relative z-10 bg-gradient-to-r from-purple-500 to-purple-700 text-transparent bg-clip-text">
                hotline
              </span>
          ...
          <div className="relative mb-6 md:mb-8">
            ...
            <div className="relative flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4">
              ...
              <p className="group relative inline-flex items-center gap-2 px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-purple-500 to-purple-700 rounded-xl md:rounded-2xl shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 transition-all duration-300">
              ...
              <span className="text-purple-700/60 text-base md:text-xl">🇨🇦</span>
            </div>
          </div>
          ...
          <div className="relative mb-8 md:mb-12 p-6 md:p-8 bg-white/5 backdrop-blur-md rounded-2xl md:rounded-3xl border border-white/10 max-w-3xl mx-4 md:mx-auto">
            ...
            <p className="inline-flex items-center gap-3 md:gap-4 px-6 md:px-10 py-3 md:py-5 bg-gradient-to-r from-purple-600 to-purple-800 rounded-xl md:rounded-2xl shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 transition-all duration-300 group">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 mb-6 md:mb-8">
            <Link
              to="/incrisisneedhelp"
              className="group relative px-6 md:px-8 py-3 md:py-4 bg-white/10 backdrop-blur-md rounded-xl md:rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300 overflow-hidden w-full sm:w-auto"
            >
              ...
              <span className="relative flex items-center justify-center gap-2 text-purple-700 text-sm md:text-base font-semibold">
                <svg
