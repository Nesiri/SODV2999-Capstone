...
const CrisisSupportBanner: React.FC = () => {
  return (
    <>
      <section className="relative w-full bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 overflow-hidden">
        {/* Main content */}
        <div className="relative max-w-6xl mx-auto text-center px-4 sm:px-6 py-12 md:py-20 lg:py-24">
          ...
          <div className="inline-block mb-6 md:mb-8">
            <div className="px-4 md:px-6 py-2 md:py-3 bg-white/5 crisis-backdrop-blur-sm rounded-xl md:rounded-2xl border border-white/10">
              <p className="text-black/80 text-xs md:text-sm lg:text-base font-light tracking-wide">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-black mb-4 md:mb-6 leading-tight px-2">
          ...
          <div className="relative mb-6 md:mb-8">
            ...
            <div className="relative flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4">
              <span className="text-black/90 text-base md:text-xl lg:text-2xl">
                Call or Text
              </span>
              <p className="group relative inline-flex items-center gap-2 px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-xl md:rounded-2xl shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 transition-all duration-300">
          ...
          <div className="relative mb-8 md:mb-12 p-6 md:p-8 bg-white/5 crisis-backdrop-blur-md rounded-2xl md:rounded-3xl border border-white/10 max-w-3xl mx-4 md:mx-auto">
            ...
            <h3 className="text-base md:text-xl lg:text-2xl text-black/90 mb-3 md:mb-4 font-light">
              If you or someone you know is in danger of hurting themselves or
              others,
            </h3>

            <p className="inline-flex items-center gap-3 md:gap-4 px-6 md:px-10 py-3 md:py-5 bg-gradient-to-r from-purple-600 to-purple-600 rounded-xl md:rounded-2xl shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 transition-all duration-300 group">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 mb-6 md:mb-8">
            <Link
              to="/incrisisneedhelp"
              className="group relative px-6 md:px-8 py-3 md:py-4 bg-white/10 crisis-backdrop-blur-md rounded-xl md:rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300 overflow-hidden w-full sm:w-auto"
            >
