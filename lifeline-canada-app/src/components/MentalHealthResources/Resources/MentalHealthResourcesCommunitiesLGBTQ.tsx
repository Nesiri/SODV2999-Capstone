...
const genderCreativeKids =
  '/assets/AdditionalResourceImages/genderCreativeKids.png';
      ...
      <div className="w-full px-6 sm:px-8 lg:px-12 relative z-10">
        <div className="w-full lg:w-4/5 mx-auto">
          <h1 className="!text-[#5f2d85] mt-4 !text-3xl sm:!text-4xl lg:text-5xl font-black tracking-tight">
            <span className="!text-[#5f2d85]">LGBTQ2S</span>
          </h1>
          ...
          <main className="mt-6 !bg-white/70 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/50 text-gray-700 flex flex-col sm:flex-row-reverse sm:items-start gap-6">
            ...
            <div className="flex-1">
              <p className="leading-relaxed">
                Despite the wide spectrum of experiences regarding mental health
                and overall well-being among lesbian, gay, bisexual, trans,
                queer-identified, and two-spirited individuals, mirroring the
                diversity seen within the broader Canadian population, they
                encounter elevated susceptibilities to specific mental health
                issues owing to the impact of discrimination and the underlying
                social determinants of health.
              </p>

              <p className="mt-4 leading-relaxed">
                Socioeconomic elements hold significant sway over the mental
                health and general well-being of each individual, with their
                importance magnified for marginalized groups. Among the pivotal
                components contributing to the nurturing of positive mental
                health and well-being, three fundamental determinants come to
                the forefront: the fostering of social inclusiveness, the
                eradication of discrimination and violence, and ensuring access
                to financial resources. The echoes of these three factors
                resonate prominently across LGBTQ2S individuals and communities
                in Canada.
              </p>
            </div>
          </main>
