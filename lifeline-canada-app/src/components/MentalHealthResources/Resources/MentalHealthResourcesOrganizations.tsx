      ...
      <div className="w-full px-6 sm:px-8 lg:px-12 relative z-10">
        <div className="w-full lg:w-4/5 mx-auto">
          <h1 className="!text-[#5f2d85] mt-4 !text-3xl sm:!text-4xl lg:!text-5xl font-black tracking-tight">
            <span className="!text-[#5f2d85]">Resource Organizations</span>
          </h1>
          ...
          <div className="mt-8 rounded-2xl border border-purple-100 !bg-white/90 backdrop-blur-sm shadow-sm p-6 sm:p-8 text-gray-700">
            <details>
              <summary className="cursor-pointer text-2xl sm:text-3xl font-bold tracking-tight !text-[#5f2d85]">
            ...
            <details>
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-5">
                ...
                <main className="mt-6 !bg-white/70 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/50 text-gray-700 flex flex-col sm:flex-row gap-6 items-start">
                  <div className="flex-1">
                    <p className="leading-relaxed">
                      There is plenty of help out there for those looking for
                      Mental Health support. We have scoured the web for some of
                      the top providers of Suicide prevention resources and
                      information. Below are links to their websites and blogs.
                    </p>

                    <p className="mt-4 leading-relaxed">
                      The guides, toolkits and resources on this page and
                      throughout this site represent a compilation of suicide
                      prevention resources from various sources across the Globe
                      as noted. When clicking 3rd party links, you will be
                      redirected to websites not affiliated but has our
                      underlying support at The LifeLine Canada Foundation.
                    </p>
                  </div>
                  <div className="sm:w-[30vw] sm:max-w-[18rem] sm:flex-shrink-0 w-full">
                    <img
                  ...
                  <details>
                    ...
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-5">
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          Kids Help Phone offers anonymous, confidential, non
                          judgemental, free 24/7 phone counselling and web
                          counselling for ages 20 and under throughout Canada.
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          Canadian Mental Health Association promotes the mental
                          health of all and supports the resilience and recovery
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          CASP is an informational association to reduce the
                          suicide rate in Canada and to minimize the
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          Offer many different types of resources, from
                          infographics to in-depth editorial articles.
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          BC’s Information Source for Children, Youth &amp;
                          Families
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          SPRC's goals are to reduce suicide, suicidal
                          behaviour, and their effects, by promoting positive
                          alternatives and healthy coping skills.
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          Klinic is an accredited crisis centre in Manitoba with
                          the American Association of Suicidology and a member
                          of the Canadian Association for Suicide Prevention and
                          the Canadian Distress Line Network.
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          Mental health problems and illnesses affect more
                          people in Canada than some of the major physical
                          disorders. Together, we accelerate change to transform
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          The Ontario Association for Suicide Prevention has
                          amalgamated with the Waterloo Region Suicide
                          Prevention Council to support a new Ontario Suicide
                          Prevention Roundtable. They will continue to provide a
                          touchstone for individuals, families and communities
                    ...
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-5">
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          ...
                          week. We&apos;re committed to improving crisis
                          services and advancing suicide prevention by
                          empowering individuals, advancing professional best
                          practices, and building awareness.
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          ...
                          organization exclusively dedicated to understanding
                          and preventing suicide through research, education,
                          and advocacy, and to reaching out to people with
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          ...
                          Services Administration maintains a mental health
                          services locator, which you can use to help find
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          Everyone experiences stress, sadness and anxiety from
                          time to time—it&apos;s part of life. But if you are
                          feeling overwhelmed, depressed, or unable to do the
                          things you once enjoyed, it may be time to assess your
                          emotional health. If you are concerned about yourself
                          or someone you love, take a few minutes to complete an
                          anonymous self-assessment. For college students,
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          DBSA is the leading patient-directed organization in
                          the United States focusing on depression and bipolar
                          disorder. They operate a toll-free referral line
                          1-800-826-3632 and have a grassroots network of more
                          than 1,000 patient-run support groups across the
                          country.
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          Promoting student mental health. Expert advice and
                          school resources for understanding disorders and
                          getting help.
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          ...
                          advocacy organization of consumers, family and friends
                          of people with mental illnesses, has information on
                          mental illnesses, programs, support groups, medication
                          and treatment, and more. There are more than a
                          thousand local affiliates in 50 states.
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          SPRC promotes the implementation of the National
                          Strategy for Suicide Prevention and enhances the
                          nation&apos;s mental health infrastructure by
                          providing states, government agencies, private
                          organizations, colleges and universities, and suicide
                          survivor and mental health consumer groups with access
                          to the science and experience that can support their
                          efforts to develop programs, implement interventions,
                          and promote policies to prevent suicide.
                        </p>
                      </div>
                    </div>
                  </details>
                    ...
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-5">
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          ...
                          (IASP) is dedicated to: preventing suicidal behaviour,
                          alleviating its effects, and providing a forum for
                          academics, mental health professionals, crisis
                          workers, volunteers and suicide survivors.
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm text-center">
                        ...
                        <p className="mt-3 leading-relaxed">
                          Our goal is to build a better, healthier future for
                          people all over the world. Working through offices in
                          more than 150 countries, WHO staff work side by side
                          with governments and other partners to ensure the
                          highest attainable level of health for all people.
                        </p>
                      </div>
                    </div>
                  </details>
