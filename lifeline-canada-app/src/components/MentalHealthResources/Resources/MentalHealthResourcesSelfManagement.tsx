...
const copingWithSuicidalThoughts =
  '/assets/AdditionalResourceImages/copingMain.webp';
const readThisFirst =
  '/assets/AdditionalResourceImages/ReadThisFirst-400x365.jpg';
const copingAndSelfCare =
  '/assets/AdditionalResourceImages/CrisisCentreBcCa-200x140.png';
...
const reasonsToGoOnLiving =
  '/assets/AdditionalResourceImages/ReasonsToGoOnLiving.png';
const reasonsForStayingAlive =
  '/assets/AdditionalResourceImages/ReasonsForStayingAlive.png';
const wellnessWorkshop =
  '/assets/AdditionalResourceImages/WellnessWorkshop.png';
const selfHelpResources =
  '/assets/AdditionalResourceImages/SelfHelpResources.png';
            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-6">
              <div className="flex-1">
                <p className="leading-relaxed">
                  ...
                  problems. When it comes to your mental health, self-care can
                  help you manage stress, lower your risk of illness, and
                  increase your energy. Even small acts of self-care in your
                  daily life can have a big impact.
                </p>
