...
const healthFactors =
  '/assets/AdditionalResourceImages/healthFactors-200x94.jpg';
const environmentalFactors =
  '/assets/AdditionalResourceImages/environmental-factors-200x150.webp';
const historicalFactors =
  '/assets/AdditionalResourceImages/More-Resources-200x196.png';
            ...
            <div className="grid grid-cols-1 items-stretch lg:grid-cols-[1fr_300px]">
              <div className="h-full p-3 text-slate-700 lg:border-r lg:border-slate-200">
                <p className="leading-relaxed">
                  What leads to suicide? There is no single cause for suicide.
                  Suicide most often occurs when stressors exceed current coping
                  abilities of someone suffering from a mental health condition.
                ...
                <p className="mt-3 leading-relaxed">
                  ...
                  it's important to note that most people who actively manage
                  their mental health conditions lead fulfilling lives.
                </p>
              </div>
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-3">
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                  ...
                  <ul className="mt-2 list-disc space-y-2 pl-5 leading-relaxed">
                    ...
                    <li>
                      Ongoing stress (bullying, relationship conflict,
                      unemployment)
                    </li>
                    <li>
                      Access to firearms or large quantities of medication/drugs
                    </li>
