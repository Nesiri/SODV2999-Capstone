          ...
          <div className="mt-8 rounded-2xl border border-purple-100 !bg-white/90 backdrop-blur-sm shadow-sm p-6 sm:p-8 text-gray-700">
            ...
            <div className="mt-6 grid gap-4 sm:gap-5">
              <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm flex flex-col sm:flex-row sm:items-start gap-4">
                ...
                />
                <div className="flex-1">
                  <h3 className="text-lg sm:!text-xl font-normal !text-[#5f2d85]">
                  ...
                  <a
                    ...
                    className="mt-5 inline-flex items-center rounded-lg bg-[#5f2d85] px-5 py-2.5 font-normal text-white shadow-sm transition-colors hover:bg-[#5f2d85]"
                  >
                    Download Guide
                  </a>
                </div>
              ...
              <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm flex flex-col sm:flex-row sm:items-start gap-4">
                ...
                <div className="flex-1">
                  <a
                    ...
                    className="text-lg sm:!text-xl font-normal !text-[#5f2d85] hover:!text-[#5f2d85] underline underline-offset-4"
                  >
