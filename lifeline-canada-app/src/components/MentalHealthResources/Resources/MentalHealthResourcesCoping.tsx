...
const problemSolve = '/assets/AdditionalResourceImages/solving-wicked-problems-200x131.jpg';
const reasonsLiving = '/assets/AdditionalResourceImages/reason-to-live-family-healthyplace-1-200x205.jpg';
const pastThings = '/assets/AdditionalResourceImages/remember-things-that-have-helped-200x131.jpg';
const getTreatment = '/assets/AdditionalResourceImages/Get-treatment-200x137.jpg';
const oppositeEmotion = '/assets/AdditionalResourceImages/Opposite-emotions-e1697413827804-200x112.jpg';
const talkToSomeone = '/assets/AdditionalResourceImages/talk-to-200x133.webp';
const professionalSupport = '/assets/AdditionalResourceImages/get-Help-200x92.png';
const selfCare = '/assets/AdditionalResourceImages/mindfulness-image-e1697585721845-200x158.jpg';
const prescriptions = '/assets/AdditionalResourceImages/follow-thru-with-prescribed-medication-200x133.webp';
