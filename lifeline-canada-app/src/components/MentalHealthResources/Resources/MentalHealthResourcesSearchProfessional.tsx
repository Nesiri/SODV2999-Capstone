...
const americanAddictionCenters = "/assets/AdditionalResourceImages/FitcyHealth.png";
        ...
        <div className="mt-6 bg-white/70 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/50 text-gray-700">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-5 bg-white rounded-lg shadow-sm border border-gray-100 flex items-start gap-4">
              <img src={eMentalHealth} alt="eMentalHealth.ca" className="w-20 sm:w-24 flex-shrink-0 rounded-lg object-contain" />
              <div>
            ...
            <div className="p-5 bg-white rounded-lg shadow-sm border border-gray-100 flex items-start gap-4">
              <img src={bcPsychologicalAssociation} alt="BC Psychological Association" className="w-20 sm:w-24 flex-shrink-0 rounded-lg object-contain" />
              <div>
            ...
            <div className="p-5 bg-white rounded-lg shadow-sm border border-gray-100 flex items-start gap-4">
              <img src={theravive} alt="Theravive" className="w-20 sm:w-24 flex-shrink-0 rounded-lg object-contain" />
              <div>
            ...
            <div className="p-5 bg-white rounded-lg shadow-sm border border-gray-100 flex items-start gap-4">
              <img src={centerForMentalHealthServices} alt="Center for Mental Health Services" className="w-20 sm:w-24 flex-shrink-0 rounded-lg object-contain" />
              <div>
            ...
            <div className="p-5 bg-white rounded-lg shadow-sm border border-gray-100 flex items-start gap-4">
              <img src={helpPROTherapistFinder} alt="HelpPRO Therapist Finder" className="w-20 sm:w-24 flex-shrink-0 rounded-lg object-contain" />
              <div>
            ...
            <div className="p-5 bg-white rounded-lg shadow-sm border border-gray-100 flex items-start gap-4">
              <img src={americanAddictionCenters} alt="American Addiction Centers" className="w-20 sm:w-24 flex-shrink-0 rounded-lg object-contain" />
              <div>
