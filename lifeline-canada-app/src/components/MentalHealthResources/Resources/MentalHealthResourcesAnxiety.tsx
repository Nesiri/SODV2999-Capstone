...
const differenceStressAnxiety = '/assets/AdditionalResourceImages/Value-img-800x799.png';
...
const AnxietyDisordersComorbidity = '/assets/AdditionalResourceImages/Neurotorium.png';
const suicideRisk = '/assets/AdditionalResourceImages/NationalLibraryOfMedicine.png';
                ...
                <main className="mt-6 flex flex-col sm:flex-row items-start gap-6 bg-white/70 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/50 text-gray-700">
                    ...
                    <div className="flex-shrink-0">
                        <img
                            ...
                            className="w-64 sm:w-80 rounded-xl shadow-md object-cover"
                        />
                    </div>
                </main>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm flex flex-col sm:flex-row items-start gap-4">
                            ...
                            <div className="flex-shrink-0">
                                <img
                                    ...
                                    className="w-48 sm:w-56 rounded-xl shadow-md object-cover"
                                />
                            </div>
                        </div>
