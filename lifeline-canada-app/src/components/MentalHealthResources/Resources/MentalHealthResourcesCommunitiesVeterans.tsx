...
const veteransAffairsCanada = '/assets/AdditionalResourceImages/governmentOfCanada-1.png';
...
const militaryMentalHealth = '/assets/AdditionalResourceImages/governmentOfCanada-1.png';

const militaryCrisisLine = '/assets/AdditionalResourceImages/militaryCrisisLine.png';
const virtualSupport = '/assets/AdditionalResourceImages/ACC.png';
const resurrectingLives = '/assets/AdditionalResourceImages/resurrectingLives.png';
...
const hopeForRecovery = '/assets/AdditionalResourceImages/hopeForRecovery-1.png';
...
const startYourRecovery = '/assets/AdditionalResourceImages/startYourRecovery.png';
const nationalCenterForPTSD = '/assets/AdditionalResourceImages/USDepartmentofVeteransAffairs.png';
const suicidePostventionPlan = '/assets/AdditionalResourceImages/suicidePostventionPlan.png';
const musicHealingVeterans = '/assets/AdditionalResourceImages/musicHealingVeterans.png';
        ...
        <section className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50 py-12">
            <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
                ...
                <div className="mt-8 rounded-2xl border border-purple-100 bg-white/90 backdrop-blur-sm shadow-sm p-6 sm:p-8 text-gray-700">
                    <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-purple-700">Canadian Resources</h2>
                ...
                <div className="mt-8 rounded-2xl border border-purple-100 bg-white/90 backdrop-blur-sm shadow-sm p-6 sm:p-8 text-gray-700">
                    <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-purple-700">USA Resources</h2>
