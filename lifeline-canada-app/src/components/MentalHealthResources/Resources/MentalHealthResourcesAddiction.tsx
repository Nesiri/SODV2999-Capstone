...
const MentalHealthResourcesAddiction: React.FC = () => {
    const resourceLinkClassName = 'text-lg font-semibold !text-purple-700 hover:!text-purple-800 focus:!text-purple-700 active:!text-purple-800 visited:!text-purple-700 underline underline-offset-4';
            ...
            <div className="w-full px-6 sm:px-8 lg:px-12 relative z-10">
                ...
                <div className="mt-8 rounded-2xl border border-purple-100 bg-white/90 backdrop-blur-sm shadow-sm p-6 sm:p-8 text-gray-700">
                    ...
                    <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="https://www.albertahealthservices.ca/findhealth/service.aspx?Id=1008399" className={resourceLinkClassName}>Alberta</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="https://www.healthlinkbc.ca/mental-health-and-substance-use/substance-use" className={resourceLinkClassName}>British Columbia</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="https://sharedhealthmb.ca/services/mental-health/" className={resourceLinkClassName}>Manitoba</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="https://www.gnb.ca/en/topic/health-wellness/mental-health.html" className={resourceLinkClassName}>New Brunswick</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="https://www.gov.nl.ca/hcs/mentalhealth-committee/mentalhealth/" className={resourceLinkClassName}>Newfoundland &amp; Labrador</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="https://www.hss.gov.nt.ca/en/contact/community-counsellor" className={resourceLinkClassName}>Northwest Territories</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="https://novascotia.ca/dhw/addictions/addiction-services-offices.asp" className={resourceLinkClassName}>Nova Scotia</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="https://nunavuthelpline.ca" className={resourceLinkClassName}>Nunavut</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="https://connexontario.ca" className={resourceLinkClassName}>Ontario</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="https://www.princeedwardisland.ca/en/information/health-pei/help-for-addiction-and-substance-use?utm_source=redirect&utm_medium=url&utm_campaign=addiction-services" className={resourceLinkClassName}>Prince Edward Island</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="" className={resourceLinkClassName}>Quebec</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="https://www.saskatchewan.ca/residents/health/accessing-health-care-services/healthline" className={resourceLinkClassName}>Saskatchewan</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            ...
                            <a href="https://yukon.ca/en/mental-wellness" className={resourceLinkClassName}>Yukon</a>
                ...
                <div className="mt-8 rounded-2xl border border-purple-100 bg-white/90 backdrop-blur-sm shadow-sm p-6 sm:p-8 text-gray-700">
                    ...
                    <div className="mt-6 grid gap-4 sm:gap-5">
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            <a href="https://www.addictioncenter.com" target="_blank" rel="noopener noreferrer" className={resourceLinkClassName}>Drug Rehab – Addiction Center</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            <a href="https://www.therecoveryvillage.com" target="_blank" rel="noopener noreferrer" className={resourceLinkClassName}>The Recovery Village</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            <a href="https://www.alcoholhelp.com" target="_blank" rel="noopener noreferrer" className={resourceLinkClassName}>Alcohol Rehab Guide</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            <a href="https://www.alternativetomeds.com/" target="_blank" rel="noopener noreferrer" className={resourceLinkClassName}>Alternative to Meds Center</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            <a href="https://www.rehabspot.com" target="_blank" rel="noopener noreferrer" className={resourceLinkClassName}>Rehab Spot</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            <a href="https://monarchshores.com" target="_blank" rel="noopener noreferrer" className={resourceLinkClassName}>Monarch Shores</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            <a href="https://rehabnet.com" target="_blank" rel="noopener noreferrer" className={resourceLinkClassName}>Drug Rehab Connections</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            <a href="https://sunshinebehavioralhealth.com" target="_blank" rel="noopener noreferrer" className={resourceLinkClassName}>Sunshine Behavioural Health</a>
                        ...
                        <div className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                            <a href="https://asanarecovery.com" target="_blank" rel="noopener noreferrer" className={resourceLinkClassName}>Asana Recovery</a>
