...
const PTSDAssociationCanada =
  '/assets/AdditionalResourceImages/PTSDAssocationCanada.png';
const USNationalCenterPTSD =
  '/assets/AdditionalResourceImages/USNationalCenterPTSD.png';
const Verywell = '/assets/AdditionalResourceImages/Verywell.png';
const LibraryOfParliament =
  '/assets/AdditionalResourceImages/LibraryOfParliament.png';
        ...
        <div className="w-full lg:w-4/5 mx-auto">
          ...
          <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-[1fr_300px] items-start">
            <div className={sectionClassName}>
              <p className="leading-relaxed">
                ...
                lives of others are in danger. They may feel afraid or feel that
                they have no control over what is happening. These feelings of
                lack of control and fear can balloon into confusion, challenges
                with memory, or intense emotion.
              </p>
              <p className="mt-4 leading-relaxed">
                Combat-related PTSD has existed as long as war itself. The
                condition was called "soldier's heart" in the Civil War, "shell
                shock" in World War I, and "Combat fatigue" in World War II.
                Despite the fact that the condition has been around for
                thousands of years, it is sometimes still difficult, or
                controversial, to diagnose.
              </p>
            </div>
          ...
          <div className="mt-6 space-y-4">
              ...
              <div className="mt-4 space-y-4">
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 flex flex-col sm:flex-row sm:items-start gap-4">
                  <div className="flex-1">
                    <p className="leading-relaxed">
                      ...
                      disorder that can occur after a person has been through a
                      traumatic event. These events can include:
                    </p>
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 flex flex-col sm:flex-row sm:items-start gap-4">
                  <div className="flex-1">
                    ...
                    <ul className="mt-3 list-disc space-y-1 pl-5 leading-relaxed">
                      ...
                      <li>
                        Being physically responsive, such as experiencing a
                        surge in your heart rate or sweating, to reminders of
                        the traumatic event
                      </li>
                      ...
                      <li>
                        Feeling constantly "on guard" or like danger is lurking
                        around every corner
                      </li>
                      <li>
                        Making an effort to avoid thoughts, feelings, or
                        conversations about the traumatic event
                      </li>
                      <li>
                        A loss of interest in important, once positive,
                        activities
                      </li>
                      <li>
                        Experiencing difficulties having positive feelings, such
                        as happiness or love
                      </li>
                    </ul>
                  </div>
                  <img
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 flex flex-col sm:flex-row sm:items-start gap-4">
                  <div className="flex-1">
                    ...
                    <p className="mt-4 leading-relaxed">
                      Sometimes PTSD can lead to unhealthy behavior like
                      substance abuse or taking unnecessary risks. Sharing your
                      experiences, feelings, and fears with others, whether with
                      friends, family, or a professional, can lessen the burden.
                    </p>
                    <p className="mt-4">
                      Source:{' '}
                      <a
            ...
            <div className={sectionClassName}>
              ...
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 flex flex-col items-center text-center">
                  <img
                    src={PTSDAssociationCanada}
                    alt="PTSD Association of Canada"
                  ...
                  <p className="mt-2 leading-relaxed">
                    Non-profit dedicated to those who suffer from and those at
                    risk for PTSD as well as those who care for traumatized
                    individuals.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 flex flex-col items-center text-center">
                  <img
                    src={USNationalCenterPTSD}
                    alt="US National Centre for PTSD"
                    className="w-full h-32 object-cover rounded-lg mb-3"
                  />
                  <a
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 flex flex-col items-center text-center">
                  ...
                  <p className="mt-2 leading-relaxed">
                    Connections between traumatic events, PTSD, and suicide
                    risk.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 flex flex-col items-center text-center">
                  <img
                    src={LibraryOfParliament}
                    alt="PTSD and Mental Health of Military"
                    className="w-full h-32 object-cover rounded-lg mb-3"
                  />
                  <a
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 flex flex-col items-center text-center">
                  ...
                  <p className="mt-2 leading-relaxed">
                    UK outreach programme helping veterans reintegrate into work
                    and family life.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 flex flex-col items-center text-center">
                  ...
                  <p className="mt-2 leading-relaxed">
                    Video resource that helps explain PTSD and recovery.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 sm:col-span-2 flex flex-col items-center text-center">
                  <img
                    src={HomecomingVets}
                    alt="Homecoming Vets and the Crossroads of Humanity"
                    className="w-full h-32 object-cover rounded-lg mb-3"
                  />
                  <a
                  ...
                  <p className="mt-2 leading-relaxed">
                    A reintegration site for veterans and their families.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed">
                As with depression or anxiety, getting the right treatment for
                PTSD depends a great deal on the individual. Sometimes
                counseling called cognitive-behavioral therapy is effective.
                Additionally, medicines known as SSRIs can help, too. Sometimes
                a combination of both therapies proves successful. Treatment can
                help people with PTSD feel more in control of their emotions and
                result in fewer symptoms, but some symptoms like bad memories or
                super-sensitivity to sounds and lights may linger.
              </p>
            </div>
          </div>
        </div>
