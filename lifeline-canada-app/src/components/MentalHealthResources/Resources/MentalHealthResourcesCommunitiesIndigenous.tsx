...
const coverPhoto =
  '/assets/AdditionalResourceImages/indigenousMentalHealth-600x400.jpg';

const ifYouAreInCrisis =
  '/assets/AdditionalResourceImages/christina-wocintechchat-com-UTw3j_aoIKM-unsplash-2-600x476.png';

const nationalAboriginalYouthSuicidePreventionStrategy =
  '/assets/AdditionalResourceImages/governmentOfCanada.png';
const nationalCollaboratingCentreForIndigenousHealth =
  '/assets/AdditionalResourceImages/nationalCollaboratingCentre.png';
const firstNationsMentalWellnessContinuumFramework =
  '/assets/AdditionalResourceImages/governmentOfCanada.png';
const aboriginalYouthNetwork = '/assets/AdditionalResourceImages/AMN.png';
const stopFamilyViolence =
  '/assets/AdditionalResourceImages/governmentOfCanada.png';
const centreForSuicidePrevention =
  '/assets/AdditionalResourceImages/CentreForSuicidePrevention-1.png';
const thinkBeforeYouShareImg =
  '/assets/AdditionalResourceImages/thinkBeforeYouShare.png';
      ...
      <div className="w-full px-6 sm:px-8 lg:px-12 relative z-10">
        <div className="w-full lg:w-4/5 mx-auto">
          <h1 className="!text-[#5f2d85] mt-4 !text-3xl sm:!text-4xl lg:text-5xl font-black tracking-tight">
            <span className="!text-[#5f2d85]">Indigenous</span>
          </h1>
          ...
          <main className="mt-6 !bg-white/70 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/50 text-gray-700 flex flex-col sm:flex-row-reverse sm:items-start gap-6">
            ...
            <div className="flex-1">
              <p className="leading-relaxed">
                So many factors can influence your health, including your mental
                health. These factors are commonly known as the determinants of
                health and include such things as how much money you make, how
                much education you have and your relationships with family and
                friends. For instance, supportive relationships with family and
                friends can make you feel cared for, loved, esteemed and valued,
                and as a result, have a protective effect on your health.
              </p>

              <p className="mt-4 leading-relaxed">
                Historical determinants, such as the legacy of residential
                schools, are believed to have shaped the mental health of
                Aboriginal people. A research project commissioned by the
                Aboriginal Healing Foundation found that 75 percent of the case
                files for a sample of Aboriginal residential school survivors
                contained mental health information with the most common mental
                health diagnoses being post-traumatic stress disorder, substance
                abuse disorder and major depression.
              </p>
            </div>
          </main>
            ...
            <div className="mt-6 grid gap-4 sm:gap-5">
              <div className="rounded-xl border border-gray-100 !bg-white p-4 sm:p-5 shadow-sm flex flex-col sm:flex-row sm:items-start gap-4">
                ...
                <div className="overflow-hidden">
                  <p className="leading-relaxed">
                    If you&apos;re experiencing emotional distress and want to
                    talk, call the First Nations and Inuit Hope for Wellness
                    Help Line at 1-855-242-3310. It&apos;s toll-free and open 24
                    hours a day, 7 days a week.
                  </p>

                  <p className="mt-4 leading-relaxed">
                    This is a National toll-free number that provides immediate,
                    culturally competent, telephone crisis intervention
                    counselling support for First Nations and Inuit, 24 hours a
                    day, seven days a week. Counsellors can also work with
                    callers to identify follow-up services they can access.
                    Counselling is available in English and French and, upon
                    request, in Cree, Ojibway, and Inuktut.
                  </p>

                  <p className="mt-4 leading-relaxed">
                    Mental health and wellness encompass both the mental and
                    emotional aspects of being - how you think and feel. Some
                  ...
                  <p className="mt-4 leading-relaxed">
                    ...
                    <a
                      href="https://www.sac-isc.gc.ca/eng/1584735005944/1585147200057"
