    ...
    return (
        <section className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50 py-12">
            <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
                ...
                <div className="mt-8 rounded-2xl border border-purple-100 bg-white/90 backdrop-blur-sm shadow-sm p-6 sm:p-8 text-gray-700">
                    <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-purple-700">Suicide Myths vs Facts</h2>
                    ...
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 [&_strong]:font-bold [&_strong]:text-purple-700">
                        {mythsVsFacts.map((item, index) => (
                            <div key={index} className="rounded-xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm">
                                <details className="rounded-lg border border-purple-100 bg-purple-50/40 p-3">
                                    ...
                                    <p className="mt-3 leading-relaxed text-gray-700">{item.myth}</p>
                                </details>
                                ...
                                <details className="mt-3 rounded-lg border border-purple-100 bg-purple-50/40 p-3">
                                    ...
                                    <p className="mt-3 leading-relaxed text-gray-700">{item.fact}</p>
                                </details>
                            </div>
                        ))}
                    </div>
