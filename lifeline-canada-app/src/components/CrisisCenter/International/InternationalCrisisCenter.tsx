              ...
              <div className="group relative !bg-white/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 lg:p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-white/50 hover:border-[#5f2d85] animate-slideInUp">
                ...
                <div className="relative">
                  <p className="text-[#4A5A5C] text-base sm:text-lg leading-relaxed">
                    <span className="inline-flex items-start gap-3 text-[#2A3B3C] font-medium mb-2">
                      <span className="w-2 h-2 bg-[#5f2d85] rounded-full mt-2 flex-shrink-0"></span>
                      <span>
                    ...
                    <br />
                    <span className="font-light text-[#4A5A5C] block mt-2">
                      The LifeLine Canada Foundation is not a crisis hotline.
                      Following are some international crisis helpline or
                      hotline information.
                    </span>
                  </p>
                </div>
