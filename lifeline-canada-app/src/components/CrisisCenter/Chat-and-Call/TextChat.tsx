            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/40 backdrop-blur-sm p-6 rounded-2xl border border-white/60">
                <p className="text-[#4A5A5C] text-lg leading-relaxed">
                  ...
                  <br />
                  <span className="font-light text-[#4A5A5C]">
                    Sometimes it is easier to open up and seek support via text,
                    where one can compose their thoughts and get things “on
                    paper” to help sort out the issues and the questions that
                    require answers and support. Text Chat Line support is also
                    ideal when one wishes to have a record of advice and a place
                    you can go back to and look at the words of support over
                    again. Below are some Crisis Text chat lines for Canada, the
                    USA, The United Kingdom and New Zealand.
                  </span>
                </p>
              </div>
            </div>
