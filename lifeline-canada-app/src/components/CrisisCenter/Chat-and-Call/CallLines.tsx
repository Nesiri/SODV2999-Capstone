        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="space-y-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <p className="text-purple-950 leading-relaxed font-medium">
                      Call or Text{' '}
                      <span className="text-3xl font-extrabold bg-gradient-to-r from-[#5f2d85] to-[#5f2d85] bg-clip-text text-transparent">
                        988
                      </span>{' '}
                      Canada's suicide prevention hotline. If you or someone you
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-sm !text-[#5f2d85]/70 leading-relaxed font-medium italic">
