...
const AdditionalCrisisResources: React.FC = () => {
  return (
    <div className="w-full bg-gradient-to-b from-[#faf8f6] to-[#f5f0ea] font-sans antialiased">
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-16 py-20 md:py-24">
        ...
        <div className="flex flex-wrap items-stretch justify-center gap-8 lg:gap-12">
          ...
          <div className="group flex-1 min-w-[220px] max-w-[300px]">
            <div className="flex flex-col items-center gap-5">
              ...
              <span className="text-xs text-[#8fa3ad] tracking-wide uppercase">
                24/7 available
              </span>
            </div>
          </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-sm text-[#b7c4bd]">
            <span className="inline-block w-1 h-1 bg-[#c9b6a4] rounded-full mx-2"></span>
