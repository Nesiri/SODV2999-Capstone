...
const crisisCentres = [
  {
    title1: 'Mental Health and Addictions Services',
    image: '/assets/CanadaCenter_image/OtherProvince/mental_health_and_addictions_access_line-400x188.jpg',
    path: 'https://www.princeedwardisland.ca/en/information/health-pei/mental-health-and-addictions-services',
    lines: [
    '24 hour province wide bilingual service: 1-833-553-6983 Toll Free'
    ],
  },
];

const PECrisisCentres: React.FC = () => {
  return (
            ...
            <div className="relative group w-fit">
              ...
              <div className="relative p-1 bg-gradient-to-r from-[#4a6fa5]/30 to-[#6b8cbc]/30 rounded-2xl shadow-2xl">
                <div className="overflow-hidden rounded-xl bg-white/50 backdrop-blur-sm">
                  <img
                    src="/assets/flags/peith_1024x1024-300x150.webp"
                    alt="prince edward island Flag"
                    className="w-70 xs:w-70 sm:w-80 md:w-96 lg:w-110 xl:w-130h-auto rounded-xl transform group-hover:scale-110 transition duration-700 ease-out"
                  />
                </div>
              </div>
...
export default PECrisisCentres;