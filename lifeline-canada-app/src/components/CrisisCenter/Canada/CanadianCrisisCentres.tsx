          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/40 backdrop-blur-sm p-6 rounded-2xl border border-white/60">
                <p className="text-[#4A5A5C] text-lg leading-relaxed">
                  ...
                  <span className="font-light text-[#4A5A5C]">
                    gives people access to suicide prevention services via call
                    or text.
                  </span>
                </p>
              </div>
              ...
              <p className="text-[#4A5A5C] text-lg font-light leading-relaxed">
                People in every province and territory who are experiencing a
                mental health crisis and need immediate, real-time support can
                use the three-digit number. Similar to 911 for accessing fire,
                police and medical emergencies, 988: Suicide Crisis Helpline is
                a short, easy-to-remember number to get a quick response from
                coast to coast to coast, 24/7 and free of charge.
              </p>

              <p className="text-[#4A5A5C] text-lg font-light leading-relaxed">
                Calls and texts to 988 will be directed to a network of partners
                in communities across the country offering suicide prevention
                services such as counselling. The 988 service is federally
                funded and available in English and French.
              </p>
            </div>
          </div>
