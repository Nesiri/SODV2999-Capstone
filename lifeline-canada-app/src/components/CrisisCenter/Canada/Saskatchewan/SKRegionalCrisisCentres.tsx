                  ...
                  <div className="space-y-1.5 sm:space-y-2">
                    {centre.lines.map((line, i) => {
                      ...
                      const isHours =
                        ...
                        line.toLowerCase().includes('mon-fri') ||
                        line.toLowerCase().includes('8am');
                      const isLocation =
                        line.includes('Swift Current') ||
                        line.includes('Five Hills') ||
                      ...
                      else if (isHours && !isMainNumber) icon = '⏰';
                      else if (isLocation && !isMainNumber && !isHours) icon = '📍';
