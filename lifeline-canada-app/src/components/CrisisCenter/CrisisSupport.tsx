...
const CrisisSupport: React.FC = () => {
  return (
    <main className="relative w-full min-h-screen bg-gradient-to-br from-purple-300 via-purple-200 to-indigo-200 font-sans antialiased overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-pink-300/30 rounded-full blur-[120px] animate-pulse-slow" style={{ animationDelay: '2s' }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md">
              ...
              {/* Image Container */}
              <div className="relative sm:top-22 rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/40">
                ...
                <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 z-20 w-full px-6">
                  <div className="backdrop-blur-md bg-black/20 rounded-full px-6 py-3 text-center border border-white/30">
                    <span className="text-purple-900 text-sm font-bold tracking-wider">
                      ✨ you are not alone ✨
                    </span>
                  </div>
                </div>
